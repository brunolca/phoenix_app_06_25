defmodule PhoenixApp0625Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixApp0625Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixApp0625Web.Gettext, "errors", msg, opts)
    end
  end
